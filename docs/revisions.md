...
- Relay footprint incorrect for intended relay (replacements avalible)
- Buzzer footprint incorrect
- Diode footprint incorrect


**Assembly Guide**: [Revision 1.0 Assembly Instructions](#assembly-rev-10)
